...
public class MainController {
	...
	@GetMapping("/")
	String home(Principal user, OAuth2AuthenticationToken authentication) {
		...
		String response = String.join(" ******* "
		         ...
		         , "First Name - " + userAttributes.get("given_name")
		         , "Last Name - " + userAttributes.get("family_name")
		);
		return response;
	}
